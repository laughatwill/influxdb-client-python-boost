...
import influxdb_client_python_boost.domain
from influxdb_client_python_boost import SigninService
from influxdb_client_python_boost import SignoutService
from influxdb_client_python_boost._async import rest
from influxdb_client_python_boost.configuration import Configuration
from influxdb_client_python_boost.rest import _requires_create_user_session, _requires_expire_user_session
...
class ApiClientAsync(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        from influxdb_client_python_boost import VERSION
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(influxdb_client_python_boost.domain, klass)
