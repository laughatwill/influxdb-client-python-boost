...
from influxdb_client_python_boost.client._base import _BaseQueryApi
from influxdb_client_python_boost.client.flux_table import FluxRecord, TableList
from influxdb_client_python_boost.client.query_api import QueryOptions
from influxdb_client_python_boost.rest import _UTF_8_encoding, ApiException
...
class QueryApiAsync(_BaseQueryApi):
    ...
    def __init__(self, influxdb_client_python_boost, query_options=QueryOptions()):
        """
        Initialize query client.

        :param influxdb_client_python_boost: influxdb client
        """
        super().__init__(influxdb_client_python_boost=influxdb_client_python_boost, query_options=query_options)

    async def query(self, query: str, org=None, params: dict = None) -> TableList:
        """
        Execute asynchronous Flux query and return result as a :class:`~influxdb_client_python_boost.client.flux_table.FluxTable` list.
        ...
        :return: :class:`~influxdb_client_python_boost.client.flux_table.FluxTable` list wrapped into
                 :class:`~influxdb_client_python_boost.client.flux_table.TableList`
        :rtype: TableList

        Serialization the query results to flattened list of values via :func:`~influxdb_client_python_boost.client.flux_table.TableList.to_values`:

        .. code-block:: python

            from influxdb_client_python_boost import InfluxDBClient
        ...
        Serialization the query results to JSON via :func:`~influxdb_client_python_boost.client.flux_table.TableList.to_json`:

        .. code-block:: python

            from influxdb_client_python_boost.client.influxdb_client_async import InfluxDBClientAsync
    ...
    async def query_stream(self, query: str, org=None, params: dict = None) -> AsyncGenerator['FluxRecord', None]:
        """
        Execute asynchronous Flux query and return stream of :class:`~influxdb_client_python_boost.client.flux_table.FluxRecord` as an AsyncGenerator[:class:`~influxdb_client_python_boost.client.flux_table.FluxRecord`].
        ...
        :param str, Organization org: specifies the organization for executing the query;
                                      ...
                                      If not specified the default value from ``InfluxDBClientAsync.org`` is used.
        :param params: bind parameters
        :return: AsyncGenerator[:class:`~influxdb_client_python_boost.client.flux_table.FluxRecord`]
        """  # noqa: E501
        org = self._org_param(org)
