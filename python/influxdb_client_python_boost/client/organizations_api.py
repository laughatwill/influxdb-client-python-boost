...
from influxdb_client_python_boost import OrganizationsService, UsersService, Organization, PatchOrganizationRequest
...
class OrganizationsApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._organizations_service = OrganizationsService(influxdb_client_python_boost.api_client)
        self._users_service = UsersService(influxdb_client_python_boost.api_client)
