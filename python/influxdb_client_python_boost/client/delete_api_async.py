...
from influxdb_client_python_boost import Organization
from influxdb_client_python_boost.client._base import _BaseDeleteApi
...
class DeleteApiAsync(_BaseDeleteApi):
    ...
    def __init__(self, influxdb_client_python_boost):
        """Initialize defaults."""
        super().__init__(influxdb_client_python_boost)
