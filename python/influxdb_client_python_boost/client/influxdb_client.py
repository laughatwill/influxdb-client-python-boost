...
from influxdb_client_python_boost import HealthCheck, HealthService, Ready, ReadyService, PingService, \
    InvokableScriptsApi
from influxdb_client_python_boost.client._base import _BaseClient
...
from influxdb_client_python_boost.client.query_api import QueryApi, QueryOptions
...
from influxdb_client_python_boost.client.write_api import WriteApi, WriteOptions, PointSettings

logger = logging.getLogger('influxdb_client_python_boost.client.influxdb_client_python_boost')
...
class InfluxDBClient(_BaseClient):
    ...
    def write_api(self, write_options=WriteOptions(), point_settings=PointSettings(), **kwargs) -> WriteApi:
        ...
        .. code-block:: python
            ...
            from influxdb_client_python_boost import InfluxDBClient
            from influxdb_client_python_boost.client.exceptions import InfluxDBError
        ...
        """
        return WriteApi(influxdb_client_python_boost=self, write_options=write_options, point_settings=point_settings, **kwargs)
