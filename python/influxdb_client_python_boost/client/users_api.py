...
from influxdb_client_python_boost import UsersService, User, Users, UserResponse, PasswordResetBody
...
class UsersApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._service = UsersService(influxdb_client_python_boost.api_client)
