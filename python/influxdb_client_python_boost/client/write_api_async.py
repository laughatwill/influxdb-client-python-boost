...
from influxdb_client_python_boost import Point, WritePrecision
...
from influxdb_client_python_boost.client.write.point import DEFAULT_WRITE_PRECISION
from influxdb_client_python_boost.client.write_api import PointSettings

logger = logging.getLogger('influxdb_client_python_boost.client.write_api_async')
...
class WriteApiAsync(_BaseWriteApi):
    ...
    def __init__(self, influxdb_client_python_boost, point_settings: PointSettings = PointSettings()) -> None:
        """
        Initialize defaults.
