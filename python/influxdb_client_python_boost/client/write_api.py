...
from influxdb_client_python_boost import WritePrecision
from influxdb_client_python_boost.client._base import _BaseWriteApi, _HAS_DATACLASS
...
from influxdb_client_python_boost.client.write.point import Point, DEFAULT_WRITE_PRECISION
from influxdb_client_python_boost.client.write.retry import WritesRetry
from influxdb_client_python_boost.rest import _UTF_8_encoding

logger = logging.getLogger('influxdb_client_python_boost.client.write_api')
...
class WriteApi(_BaseWriteApi):
    ...
    Example:
        .. code-block:: python
            ...
            from influxdb_client_python_boost.client.write_api import SYNCHRONOUS
    ...
    def __init__(self,
        ...
        :param influxdb_client_python_boost: with default settings (organization)
        ...
        :key retry_callback: The callable ``callback`` to run after retryable error occurred.
                             ...
                             **[batching mode]**
        """
        super().__init__(influxdb_client_python_boost=influxdb_client_python_boost, point_settings=point_settings)
