...
from influxdb_client_python_boost import Script, InvokableScriptsService, ScriptCreateRequest, ScriptUpdateRequest, \
    ScriptInvocationParams
from influxdb_client_python_boost.client._base import _BaseQueryApi
from influxdb_client_python_boost.client.flux_csv_parser import FluxResponseMetadataMode
...
class InvokableScriptsApi(_BaseQueryApi):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._invokable_scripts_service = InvokableScriptsService(influxdb_client_python_boost.api_client)
