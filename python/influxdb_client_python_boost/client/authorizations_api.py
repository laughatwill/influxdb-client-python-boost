...
from influxdb_client_python_boost import Authorization, AuthorizationsService, User, Organization
...
class AuthorizationsApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._authorizations_service = AuthorizationsService(influxdb_client_python_boost.api_client)
