...
from influxdb_client_python_boost import InfluxDBClient, WriteOptions
from influxdb_client_python_boost.client.exceptions import InfluxDBError

logger = logging.getLogger('influxdb_client_python_boost.client.util.multiprocessing_helper')
...
class MultiprocessingWriter(multiprocessing.Process):
    ...
    Example:
        .. code-block:: python
            ...
            from influxdb_client_python_boost import WriteOptions
            from influxdb_client_python_boost.client.util.multiprocessing_helper import MultiprocessingWriter
