...
class FluxTable(FluxStructure):
    ...
    The table can be serialized into JSON by::
        ...
        import json
        from influxdb_client_python_boost.client.flux_table import FluxStructureEncoder
...
class TableList(List[FluxTable]):
    """:class:`~influxdb_client_python_boost.client.flux_table.FluxTable` list with additionally functional to better handle of query result."""  # noqa: E501
