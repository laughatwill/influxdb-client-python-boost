...
from influxdb_client_python_boost import TasksService, Task, TaskCreateRequest, TaskUpdateRequest, LabelResponse, LabelMapping, \
...
class TasksApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._service = TasksService(influxdb_client_python_boost.api_client)
