...
from influxdb_client_python_boost import Dialect
...
class QueryApi(_BaseQueryApi):
    ...
    def query_csv(self, query: str, org=None, dialect: Dialect = _BaseQueryApi.default_dialect, params: dict = None) \
        ...
        :return: :class:`~Iterator[List[str]]` wrapped into :class:`~influxdb_client_python_boost.client.flux_table.CSVIterator`
        :rtype: CSVIterator

        Serialization the query results to flattened list of values via :func:`~influxdb_client_python_boost.client.flux_table.CSVIterator.to_values`:
        ...
        .. code-block:: python
            ...
            from influxdb_client_python_boost import InfluxDBClient, Dialect
    ...
    def query(self, query: str, org=None, params: dict = None) -> TableList:
        """Execute synchronous Flux query and return result as a :class:`~influxdb_client_python_boost.client.flux_table.FluxTable` list.
