...
from influxdb_client_python_boost import BucketsService, Bucket, PostBucketRequest, PatchBucketRequest
...
class BucketsApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._buckets_service = BucketsService(influxdb_client_python_boost.api_client)
