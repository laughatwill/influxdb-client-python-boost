...
from influxdb_client_python_boost import PingService
from influxdb_client_python_boost.client._base import _BaseClient
from influxdb_client_python_boost.client.delete_api_async import DeleteApiAsync
from influxdb_client_python_boost.client.query_api import QueryOptions
from influxdb_client_python_boost.client.query_api_async import QueryApiAsync
from influxdb_client_python_boost.client.write_api import PointSettings
from influxdb_client_python_boost.client.write_api_async import WriteApiAsync

logger = logging.getLogger('influxdb_client_python_boost.client.influxdb_client_async')
...
class InfluxDBClientAsync(_BaseClient):
    ...
    def write_api(self, point_settings=PointSettings()) -> WriteApiAsync:
        ...
        """
        return WriteApiAsync(influxdb_client_python_boost=self, point_settings=point_settings)
