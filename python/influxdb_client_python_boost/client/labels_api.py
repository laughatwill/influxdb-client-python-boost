...
from influxdb_client_python_boost import LabelsService, LabelCreateRequest, Label, LabelUpdate
...
class LabelsApi(object):
    ...
    def __init__(self, influxdb_client_python_boost):
        ...
        self._service = LabelsService(influxdb_client_python_boost.api_client)
